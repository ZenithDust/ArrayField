...
function SolarisLib:New(Config)
    ...
    function MusicConstructor()
        ...
        MusicFrame.Frame.TopBar.Btn.MouseButton1Click:Connect(function()
            MusicFrame.Visible = false
        end)
        MusicFrame.Frame.TopBar.Btn.MouseEnter:Connect(function() TweenService:Create(MusicFrame.Frame.TopBar.Btn.Ico,TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{ImageTransparency = 0}):Play() end)
        MusicFrame.Frame.TopBar.Btn.MouseLeave:Connect(function() TweenService:Create(MusicFrame.Frame.TopBar.Btn.Ico,TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{ImageTransparency = 0.4}):Play() end)
        ...
        spawn(function()
            while wait() do
                ...
                MusicFrame.Frame.TopBar.Btn.Ico.ImageColor3 = SolarisLib.Themes[SolarisLib.Settings.Theme].TextColor
    ...
    function SettingsConstructor()
        ...
        SFrame.TopBar.Btn.MouseEnter:Connect(function() TweenService:Create(SFrame.TopBar.Btn.Ico,TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{ImageTransparency = 0}):Play() end)
        SFrame.TopBar.Btn.MouseLeave:Connect(function() TweenService:Create(SFrame.TopBar.Btn.Ico,TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{ImageTransparency = 0.4}):Play() end)
        SettingsBtn.MouseButton1Click:Connect(function()
            SettingsFrame.Visible = not SettingsFrame.Visible
            MFrame.TopBar.ButtonHolder.MenuBtn.MenuFrame.Visible = false 
        end)
        SFrame.TopBar.Btn.MouseButton1Click:Connect(function()
        ...
        spawn(function()
            while wait() do
                ...
                SFrame.TopBar.Btn.Ico.ImageColor3 = SolarisLib.Themes[SolarisLib.Settings.Theme].TextColor
        ...
        general:BindSetting(" Bind", "Hides/Shows the main window when pressed.", Enum.KeyCode.RightControl, "Bind")
    ...
    MFrame.TabMenu.Menu.Top.MenuBtn.MouseButton1Click:Connect(function()
        TabMenu()
    end)
    ...
    MFrame.TopBar.ButtonHolder.Btn.MouseEnter:Connect(function() TweenService:Create(MFrame.TopBar.ButtonHolder.Btn.Ico,TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{ImageTransparency = 0}):Play() end)
    MFrame.TopBar.ButtonHolder.Btn.MouseLeave:Connect(function() TweenService:Create(MFrame.TopBar.ButtonHolder.Btn.Ico,TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),{ImageTransparency = 0.4}):Play() end)
    ...
    MFrame.TopBar.ButtonHolder.Btn.MouseButton1Click:Connect(function()
	...
	UserInputService.InputBegan:Connect(function(Input)
		if (Input.KeyCode.Name == SolarisLib.Settings.Bind or Input.UserInputType.Name == SolarisLib.Settings.Bind) and not bindbinding then
            uitoggled = not uitoggled
            MainUI.Visible = uitoggled
		end
	end)
    ...
    spawn(function()
        while wait() do
            ...
            MFrame.TopBar.ButtonHolder.Btn.Ico.ImageColor3 = SolarisLib.Themes[SolarisLib.Settings.Theme].TextColor
            ...
            MFrame.TabMenu.Menu.Top.MenuBtn.ImageLabel.ImageColor3 = SolarisLib.Themes[SolarisLib.Settings.Theme].TextColor
